...
S1_OFF:
      sbis pinb,S1	; Pula a próxima instrução caso S1 esteja em 1 (Sensor desativado).Verifica se o pino PB0 está em 1 (setado)e pula a próxima instrução
      rjmp S1_OFF	; Volta para S1_OFF caso pino em (0) sensor ativado
      
S1_ON:
      sbic pinb,S1	 	; Pula a próxima instrução caso S1 esteja em 0 (Sensor ativado). Verifica se o pino pb0 está clear
