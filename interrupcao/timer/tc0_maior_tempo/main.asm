...
utilizando extender o tempo de alteracao de nivel de Rb1 (label alterna)
a cada estou incrementa R17 e compara se alcancou o valor maximo R18=50
...
TIM0_OV:   
	...
	inc r17
	ldi r18,50  ; limite
	cp r17,r18 ;compara se R17 alcancou o valor maximo em R18
    breq alterna
    reti
  alterna:
    clr r17
