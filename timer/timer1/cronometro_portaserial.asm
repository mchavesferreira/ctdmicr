...
; interrupcao do TC1, cronometro , botao inicial em int0 e final no proprio int0 invertendo sentido de disparo. botao reset
; Prof. Marcos Chaves
...
.EQU DIG3  = 0X03D0            ;DIGITO 3
.EQU DIG4  = 0X03CF            ;DIGITO 4
...
.org 0x0020  ; overflow de tcnt0 valor top
     rjmp TIM0_OV    
.ORG 0x0014 
     rjmp TIM1_captura ; Interrupcao por estouro de timer 1 (modo normal)
...
;          CONFIGURA TIMER 0 PARA MULTIPLEXAR DISPLAY A CADA 10ms
...
;
	ldi r16,0b01010000    ; pinos desconectados 
...
;==============================================================	
; exibe valor NO DIGITOS EM HEXADECIMAL
TIM0_OV:
     sbi PORTC,0
	 sbi PORTC,1
	 sbi PORTC,2
...
findunidades:
    ...
    ; add dezenas,r29
	; add unidades,r29
;	mov lcd_caracter,centenas  funcoes para LCD
